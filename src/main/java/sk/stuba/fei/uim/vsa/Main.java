...
public class Main {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:h2:file:./database;SCHEMA=PUBLIC;DATABASE_TO_UPPER=true", "", "");

        BookRepositoryInterface repository = new BookRepository(connection);
        BookServiceInterface service = new BookService(repository);


        double cenaKnihy = service.cenaKnihy("Kokoti");
        System.out.println(cenaKnihy);
